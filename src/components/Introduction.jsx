    ...
    <div className="h-screen w-full">
      <div className="h-screen bg-white  " id="introduction">
        <div className="relative isolate pt-14">
          ...
          <div className="mx-auto h-screen max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40 ">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 2xl:pt-12 2xl:text-xl">
                Nhat-Quan HO NGUYEN, passionné de front-end et en quête
            ...
            <div className=" mt-40  sm:mt-24 md:block  lg:ml-16  lg:flex-shrink-0 lg:flex-grow   ">
              <img
                src="/blackclothesprofil2.png"
                alt="blackclothesprofil2"
                className=" rounded-tl-60 rounded-tr-40-30 rounded-bl-70-40 rounded-br-30-70 ml-20 hidden h-72 w-auto bg-indigo-600 object-cover md:block md:h-[500px]  2xl:h-[600px] "
              />
            </div>
          </div>
        </div>
