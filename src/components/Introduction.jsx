...
export default function Introduction() {
  return (
    <div className=" h-full  w-full p-8 pt-20 lg:flex lg:h-screen lg:items-center lg:justify-center lg:px-20 lg:pt-[15%] xl:pl-20 xl:pr-40 xl:pt-20 2xl:px-0 2xl:pt-0 ">
      <div className=" block h-full w-full  flex-row-reverse p-10 lg:flex lg:gap-10 xl:justify-center 2xl:h-[500px] 2xl:w-full 2xl:gap-20">
        <div className="lg: text-3xl font-bold ">
          <img
            className="h-45 rounded-custom   mx-auto  block h-full bg-orange-400 sm:w-1/2 lg:h-[80%] lg:w-full  2xl:h-full 2xl:w-full"
            src="/blackclothesprofil2.png"
            alt="blackclothesprofil"
          />
        </div>
        <div className="  block items-center  justify-center text-center sm:mx-40 lg:mx-0 lg:w-[45%]  lg:text-ellipsis lg:text-left 2xl:w-[25%] ">
          ...
          <p className="flex justify-center py-3 text-3xl lg:justify-normal  lg:text-2xl  ">
            <a
          ...
          <div className="my-10 ">
            ...
            <div className=" flex justify-center p-4 text-3xl lg:justify-normal lg:p-0  lg:py-3 lg:text-2xl ">
