export default function About() {
  return (
    <div className="block h-full w-full pt-10   lg:flex lg:h-screen lg:items-center lg:justify-center  xl:px-40 ">
      <img
      ...
      <div className="m-10 block items-center justify-center text-center sm:mx-40 lg:mx-20">
        ...
        <p className="py-10">
          ...
          épanouissants. Contactez-moi pour discuter de vos idées.
        </p>
      </div>
    </div>
  );
